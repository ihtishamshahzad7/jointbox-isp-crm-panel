...
# SKIP entirely if the frontend already binds 80 (FRONTEND_PORT=80) — then the
# redirect would send :80 to an empty $WEB_PORT and break external access.
if [ "$WEB_PORT" != "80" ] && [ "${FRONTEND_PORT:-}" != "80" ]; then
